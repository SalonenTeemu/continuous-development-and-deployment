...
The project application versions are available in the branches `project1.0` and `project1.1` and can be viewed and tested in the same manner as described in the exercises above.
